...
# База данных клиентов компании (компании-клиенты, контактные лица в данных компаниях, продукты компании, заказы и пр.) 
...
# типы выбранных продуктов, имя и фамилию консультантов, которые писали сообщения
